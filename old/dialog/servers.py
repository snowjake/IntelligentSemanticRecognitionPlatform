...
while flag:
       ...
       while 1:
                ...
                print(josn_dict)
                results=dia(josn_dict['task'], josn_dict['intention'], josn_dict['slot'])
                #print(results)
                nlu.to_speaker(josn_dict['task'],results)
                if results['action']=='done':
                       ...
                       conn.send(results['action'].encode())
